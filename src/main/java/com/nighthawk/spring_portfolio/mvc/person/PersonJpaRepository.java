...
/**
 * The PersonJpaRepository interface is automatically implemented by Spring Data
 * JPA at runtime.
 * It uses the Java Persistence API (JPA) - specifically, Hibernate - to map,
 * store, update, and retrieve data from relational databases.
 * 
 * This interface extends JpaRepository, which provides CRUD (Create, Read,
 * Update, Delete) operations.
 * Through the JPA the developer can store and retrieve Java objects to and from
 * the database.
 * 
 ...
 * 
 * JpaRepository provides several methods for interacting with the database,
 * including:
 * - save(T entity): save an entity to the database. If T.id exists update, Else
 * create/insert.
 ...
 * 
 * When a method from this interface is called, the call is intercepted by a
 * Spring Data JPA proxy, which directs the call to the appropriate method in
